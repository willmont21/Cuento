...
public class capsula6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_capsula6);

        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,WindowManager.LayoutParams.FLAG_FULLSCREEN);

        videoView = (VideoView) findViewById(R.id.videoView);
        c2mediaPlayer = MediaPlayer.create(this, R.raw.transporte);
        c2mediaPlayer2 = MediaPlayer.create(this, R.raw.lohicistebien);
        swipe=(TextView) findViewById(R.id.textView);
        intent = new Intent(this, capsula7.class);


// Set the media controller buttons
        if (mediaController == null) {
            mediaController = new MediaController(capsula6.this);
        ...
        try {
            // ID of video file.
            int id = this.getRawResIdByName("cap2");
